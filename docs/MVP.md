...
Shipped in 2.4.0: latitude climate bands, coastal versus inland seasonal range, one capped slope slump, and rivers whose width and Strahler order follow mouth discharge. The upwind walk stays bounded. Wind restamp still does not rebuild rivers.
