...
3. **陆形** 决定海岸轮廓：诸大陆、盘古、群岛、大岛、半岛、地峡、内海、湖区。板块仍负责山链。
4. **抬升 / 降低** 是主要编辑工具：在陆地上涂抹，松手后河流会按重力重算。
5. **河流** 从高地拖向大海；**建城 / 擦除 / 地标** 种城镇和兴趣点；**移动** 把城镇拖到陆地上；**命名** 点击改名；**测距** 量里格。
6. **图层** 在图集、地势、政治、文化、行省、信仰、气温、降水之间切换；商路与地标可单独关掉。底部状态栏显示当前格子。
7. **重掷文明** 只重做人名与国家，地形不动。名册与检索用来跳转到聚落、国度、行省、文化、信仰、地貌、地标。检视里可以写战役笔记。
8. **F1** 打开说明。**链接** 复制可分享地址。**导出 JSON** 保存完整世界；**槽位** 把最多六张图存在本机 IndexedDB；**导出 PNG** 出图。

### 功能一览

- 板块造山、重力河流、雨影气候、Whittaker 生物群系
- 陆形模板（群岛 / 大岛 / 半岛 / 盘古 / 内海…）
- 文化扩张与语音、国度、行省、信仰、外交、命名地貌、商路、地标
- 图层预设、全图国名与大陆名、地名防撞、比例尺、测距、状态栏
- 可分享链接、自动存档恢复（IndexedDB）、命名槽位、撤销/重做、Web Worker 生成
